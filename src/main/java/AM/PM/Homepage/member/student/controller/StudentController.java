...
public class StudentController {
    ...
    @PostMapping("info")
    public ResponseEntity<StudentInformationResponse> showStudentInformation(@RequestBody VerificationCodeRequest verificationCodeRequest,
                                                                              @AuthenticationPrincipal UserAuth userAuth) {
    ...
    public ResponseEntity<StudentInformationResponse> showStudentInformationForTest(@RequestBody VerificationCodeRequest request,
                                                                                    @AuthenticationPrincipal UserAuth userAuth) {

        return ResponseEntity.ok(studentService.showStudentInformationForTest(request.getSolvedAcNickname(), userAuth.getUsername()));
    }
